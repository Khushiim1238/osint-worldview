...
export const SIGNUP_URLS: Partial<Record<RuntimeSecretKey, string>> = {
  JARVIS_API_URL: 'https://github.com/khushijain/jarvis-ai',
  JARVIS_API_TOKEN: 'https://github.com/khushijain/jarvis-ai',
...
export const HUMAN_LABELS: Record<RuntimeSecretKey, string> = {
  ...
  WORLDMONITOR_API_KEY: 'WorldView License Key',
...
export const SETTINGS_CATEGORIES: SettingsCategory[] = [
  ...
  },
  {
    ...
    features: ['wingbitsEnrichment', 'nasaFirms', 'aviationStack', 'icaoNotams', 'newsPerFeedFallback'],
  },
];
